...
def _(mo):
    ...
    The displayed Theorem 4.3 bound evaluates to **zero** on a constant
    mechanism path, while the exact estimator MSE is **0.0340467**.
    The preserved constant-noise mode alone contributes **0.00390625**.
...
def _(mo):
    status_rows = [
        ...
        {"claim": 3, "status": "BLOCKED", "basis": "learned run pending; NCTRL protocol absent"},
        {"claim": 4, "status": "BLOCKED", "basis": "real-data assets and protocol absent"},
        {"claim": 5, "status": "RUNNING", "basis": "paper-scale learned CPU run"},
