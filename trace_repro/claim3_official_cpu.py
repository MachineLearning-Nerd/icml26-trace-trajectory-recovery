"""Run one paper-scale epoch of the released TRACE implementation on CPU.
...
and loss weights from the released five-domain configuration.
"""
...
def main() -> int:
    ...
    output_path = OUTPUT / "cpu_calibration.json"
    output_path.write_text(json.dumps(result, indent=2, sort_keys=True) + "\n")
    print("\nTRACE_OFFICIAL_CPU_CALIBRATION")
